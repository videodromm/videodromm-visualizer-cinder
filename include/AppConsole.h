...
namespace VideoDromm
{
	...
	{
	public:
		AppConsole(VDSettingsRef aVDSettings, VDUtilsRef aVDUtils);
		static AppConsoleRef	create(VDSettingsRef aVDSettings, VDUtilsRef aVDUtils)
		{
			return shared_ptr<AppConsole>(new AppConsole(aVDSettings, aVDUtils));
		}
		void    ClearLog();
